...
- Optionally highlights today's weekday label in red in the header row for quick recognition.
...
- **Highlight today's weekday:** Colors today's weekday label red in the header row for quick recognition. Disabled by default.
...
- **高亮今天的星期：** 在表头将今天对应的星期文字标红，便于一眼定位当日，默认关闭。
...
[![Obsidian 交流聊天反馈群二维码](https://blog.discoverlabs.ac.cn/img/wechat-publisher/feedback-group-qr.png?v=20260720112042)](https://blog.discoverlabs.ac.cn/posts/0000-obsidian交流聊天反馈群/)
